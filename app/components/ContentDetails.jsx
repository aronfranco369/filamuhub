...
import FilamuHeader from "./Header";
...
const ContentDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-900 min-h-screen text-white">
      {/* Header and image sections remain unchanged */}
      ...
      {/* Updated Episodes Section with collapsible functionality */}
          ...
          >
            <div className="space-y-4">
              {content.episodes
                .slice(
                  0,
                  isEpisodesExpanded ? undefined : INITIAL_EPISODES_SHOWN
                )
                .map((episode) => (
                  <Card
                    key={episode.id}
